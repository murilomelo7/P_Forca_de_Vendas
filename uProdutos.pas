...
begin
  ...
  begin
    ...
    TListItemText(Objects.FindDrawable('txtCodigoProduto')).Text := IntToStr(produto.codigo);
    TListItemText(Objects.FindDrawable('txtNomeProduto')).Text := produto.nome;
    TListItemText(Objects.FindDrawable('txtPrecoProduto')).Text :=  FloatToStr(produto.preco);
  end;
