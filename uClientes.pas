...
type
  ...
  TfrmClientes = class(TForm)
    ...
    procedure ListViewClientesItemClickEx(const Sender: TObject; ItemIndex: Integer;
...
//   Insere cliente por cliente na list
  with ListViewClientes.Items.Add do
  begin

    TListItemText(Objects.FindDrawable('txtCodigo')).Text :=
      IntToStr(cliente.codigo);
...
procedure TfrmClientes.ListViewClientesItemClickEx(const Sender: TObject;
...
begin
  ...
  id_cliente := StrToInt(TListItemText(ListViewClientes.Items[ItemIndex]
    .Objects.FindDrawable('txtCodigo')).Text);
